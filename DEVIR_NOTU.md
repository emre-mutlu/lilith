...
## Durum
Aktif. Model migration tamamlandı; bu oturumda kapsamlı **tasarım + araştırma yön kararları** alındı (ürün ve makaleyi birlikte besleyecek).
...
1. **v0 `tasarim_notlari.md`** yaz: tek cümlelik deneyim tezi + 3–5 ilke (her biri kanıt tabanına bağlı) + **yüzey taksonomisi** (immersion-kritik vs araç) + **gerekçe-kartı şablonu** (*iddia → tasarım kararı → kanıt → ödün*). Bu dosya makalenin birincil kaynağı ("menteşe").
